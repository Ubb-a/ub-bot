        ...
        const helpEmbed = new EmbedBuilder()
            ...
            .addFields(
                ...
                },
                {
                    ...
                    value: 'عرض جميع المهام مع إمكانية التفاعل\n**التفاعل:** كل مهمة لها إيموجي مخصص للإنجاز | ❌ إخفاء من قائمتك',
                    inline: false
                },
                {
            ...
            .addFields({
                name: '🚀 كيفية البدء',
                value: '1. استخدم `!create` لإنشاء خريطة طريق جديدة\n2. استخدم `!addtask` لإضافة مهام للخريطة (كل مهمة تحصل على إيموجي مخصص)\n3. استخدم `!tasks` لعرض المهام والتفاعل معها بالإيموجي\n4. استخدم `!taskstats` لمراقبة تقدم الأعضاء (للإداريين)\n5. استخدم `!showroadmap` لمراجعة تفاصيل خريطة معينة',
                inline: false
            })
            .setTimestamp()
            .setFooter({
